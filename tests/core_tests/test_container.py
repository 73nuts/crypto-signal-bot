...
class TestGlobalContainer(unittest.TestCase):
    ...
    def test_get_container_singleton(self):
        ...
        from src.core.container import _reset_container, get_container
    ...
    def test_inject_function(self):
        ...
        from src.core.container import _reset_container, get_container, inject
...
class TestInjectableDecorator(unittest.TestCase):
    ...
    def test_injectable_registers_class(self):
        ...
        from src.core.container import _reset_container, get_container, injectable
