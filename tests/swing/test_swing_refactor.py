...
class TestSwingConfig:
    ...
    def test_symbol_config(self):
        ...
        from src.strategies.swing.config import get_symbol_config, STRATEGY_ENSEMBLE, STRATEGY_BREAKOUT
...
class TestPhase2DataProvider:
    ...
    def test_data_provider_protocol(self):
        ...
        from src.strategies.swing.data_provider import (
            DataProvider,
            BinanceDataProvider,
            LocalFileDataProvider
        )
